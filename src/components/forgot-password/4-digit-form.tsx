      ...
      <div className="space-y-4">
        <div className="flex justify-center gap-3">
          <input
            ...
            onPaste={handlePaste}
            className="h-14 w-14 rounded-lg border-2 border-[var(--background-200)] bg-[var(--background-100)] text-center font-semibold text-2xl text-[var(--foreground-100)] text-lg outline-none focus:border-[var(--foreground-100)] focus:ring-2 focus:ring-[var(--foreground-100)] focus:ring-offset-1"
            aria-label="Digit 1"
          />
          <input
            id="code-1"
